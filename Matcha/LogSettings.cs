...
namespace Matcha
{
	...
	public class MatchaLoggerSettings
	{
		...
		/// <para/>
		/// Set the <see cref="OverwriteIfExists"/> property to <c>true</c> if you don't want this behavior.
		/// <para/>
		...
		/// </summary>
		public LogSeverity AllowedSeverities = LogSeverity.Debug | LogSeverity.Information | LogSeverity.Warning | LogSeverity.Error;
	}
}
